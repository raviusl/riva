...
import type { NotificationActivityItem } from "@/features/notification/lib/notification-types";
import { uiZh } from "@/config/ui-zh";

type NotificationWorkspaceActivityPanelProps = {
...
/**
 * Activity Timeline for Notification Workspace.
 * Same feed pattern as Task / Document / Finance Workspace Activity.
 */
export function NotificationWorkspaceActivityPanel({
  activities,
}: NotificationWorkspaceActivityPanelProps) {
  return (
