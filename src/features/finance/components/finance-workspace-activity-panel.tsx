...
import type { FinanceActivityItem } from "@/features/finance/lib/finance-types";
import { uiZh } from "@/config/ui-zh";

type FinanceWorkspaceActivityPanelProps = {
...
/**
 * Activity Timeline for Finance Workspace.
 * Same feed pattern as Task / Document Workspace Activity.
 */
export function FinanceWorkspaceActivityPanel({
  activities,
}: FinanceWorkspaceActivityPanelProps) {
  return (
