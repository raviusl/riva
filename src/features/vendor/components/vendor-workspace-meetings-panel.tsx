...
type VendorWorkspaceMeetingsPanelProps = {
...
export function VendorWorkspaceMeetingsPanel({
  meetings,
}: VendorWorkspaceMeetingsPanelProps) {
  return (
    <section className="rounded-2xl border border-white/[0.08] bg-white/[0.03] px-5 py-5">
      <div>
        ...
        <p className="mt-1 text-xs text-white/45">{uiZh.relatedMeetingsDesc}</p>
      </div>
