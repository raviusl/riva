...
type TaskWorkspaceActivityPanelProps = {
...
export function TaskWorkspaceActivityPanel({
  activities,
}: TaskWorkspaceActivityPanelProps) {
  return (
    <section className="rounded-2xl border border-white/[0.08] bg-white/[0.03] px-5 py-5">
      <div>
        ...
        <p className="mt-1 text-xs text-white/45">
          Task history for this company — newest first
        </p>
      </div>
